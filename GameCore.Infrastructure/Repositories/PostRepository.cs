...
namespace GameCore.Infrastructure.Repositories
{
    public class PostRepository : Repository<Post>, IPostRepository
    {
        ...
        public PostRepository(GameCoreDbContext context, ILogger<PostRepository> logger) : base(context)
        {
            _logger = logger;
        }
        ...
        public async Task<IEnumerable<Post>> GetByForumIdAsync(int forumId, CancellationToken cancellationToken = default)
        {
            return await GetByForumIdAsync(forumId, 1, 50);
        }
        ...
        public async Task<IEnumerable<Post>> GetByStatusAsync(string status, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IEnumerable<Post>> SearchAsync(string keyword, CancellationToken cancellationToken = default)
        {
            return await SearchPostsAsync(keyword, 1, 50);
        }

        public async Task<IEnumerable<Post>> GetPopularPostsAsync(int limit, CancellationToken cancellationToken = default)
        {
            return await _context.Posts
                .Include(p => p.Author)
                .Include(p => p.Forum)
        ...
        public async Task<bool> UpdateStatusAsync(int postId, string status, CancellationToken cancellationToken = default)
        {
            var post = await GetByIdAsync(postId);
        ...
        public async Task<bool> IncrementViewCountAsync(int postId, CancellationToken cancellationToken = default)
        {
            await UpdateViewCountAsync(postId);
            return true;
        }
    }
}