...
namespace GameCore.Infrastructure.Repositories
{
    ...
    public class SignInRepository : Repository<SignInRecord>, ISignInRepository
    {
        ...
        public SignInRepository(GameCoreDbContext context, ILogger<SignInRepository> logger) : base(context)
        {
            _logger = logger;
        }
        ...
        /// 根據使用者ID取得最新簽到記錄
        /// </summary>
        public async Task<SignInRecord?> GetByUserIdAsync(int userId)
        {
            return await _context.SignInRecords
